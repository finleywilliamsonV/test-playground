...
import { RandomImageCardComponent } from './random-image-card.component'
import { catchError, EMPTY, finalize, take, tap, timeout } from 'rxjs'
import { HttpClientModule } from '@angular/common/http'

describe('RandomImageCardComponent', () => {
    let component: RandomImageCardComponent
    let fixture: ComponentFixture<RandomImageCardComponent>

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [HttpClientModule],
            declarations: [RandomImageCardComponent]
        }).compileComponents()

        fixture = TestBed.createComponent(RandomImageCardComponent)
    ...
    it('should load the spinner on initialization', () => {
        const spinnerElement: Element | null = fixture.nativeElement.querySelector('#spinner-icon')
